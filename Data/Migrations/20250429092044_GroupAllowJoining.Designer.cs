...
namespace QuickFinder.Migrations
{
    ...
    [Migration("20250429092044_GroupAllowJoining")]
    partial class GroupAllowJoining
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuickFinder.Domain.Matchmaking.CoursePreferences", b =>
                {
                    b.Property<string>("UserId")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("QuickFinder.Domain.Matchmaking.GroupTicket", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.ToTable("GroupTickets");
                });

            modelBuilder.Entity("QuickFinder.Domain.Matchmaking.Preferences", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
                    ...
                    b.Property<int>("GlobalAvailability")
                        .HasColumnType("INTEGER");

                    b.Property<int>("GlobalDays")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("QuickFinder.Domain.Matchmaking.Group", b =>
                {
                    ...
                    b.HasOne("QuickFinder.Domain.Matchmaking.Preferences", "Preferences")
                        .WithMany()
            ...
            modelBuilder.Entity("QuickFinder.Domain.Matchmaking.GroupTicket", b =>
                {
                    ...
                    b.HasOne("QuickFinder.Domain.Matchmaking.Group", "Group")
                        .WithMany()
                    ...
                    b.OwnsOne("QuickFinder.Domain.Matchmaking.UserPreferences", "Preferences", b1 =>
                        {
                            ...
                            b1.Property<int>("GlobalAvailability")
                                .HasColumnType("INTEGER");

                            b1.Property<int>("GlobalDays")
                                .HasColumnType("INTEGER");
