...
namespace QuickFinder.Migrations
{
    ...
    public partial class LinkChannelAndServer : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.DropIndex(name: "IX_Courses_ServerId", table: "Courses");

            migrationBuilder.DropIndex(name: "IX_Channel_ServerId", table: "Channel");

            migrationBuilder.DropColumn(name: "ServerId", table: "Courses");

            migrationBuilder.DropColumn(name: "CategoryId", table: "Channel");
        }
    }
}
